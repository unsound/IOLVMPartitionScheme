...
/**
 * lvm2_endians.h - Definitions related to handling of byte ordering.
 *                  Originated from the Linux-NTFS project.
 */

#ifndef _TLVM_LVM2_ENDIANS_H
#define _TLVM_LVM2_ENDIANS_H

#if (defined(__DARWIN__) || defined (__APPLE__)) && defined(KERNEL)

#include <libkern/OSByteOrder.h>

#define __ntfs_bswap_constant_16(x) OSSwapConstInt16(x)
#define __ntfs_bswap_constant_32(x) OSSwapConstInt16(x)
#define __ntfs_bswap_constant_64(x) OSSwapConstInt64(x)
...
#define __constant_le16_to_cpu(x) OSSwapLittleToHostConstInt16(x)
#define __constant_le32_to_cpu(x) OSSwapLittleToHostConstInt32(x)
#define __constant_le64_to_cpu(x) OSSwapLittleToHostConstInt64(x)

#define __constant_cpu_to_le16(x) OSSwapHostToLittleConstInt16(x)
#define __constant_cpu_to_le32(x) OSSwapHostToLittleConstInt32(x)
#define __constant_cpu_to_le64(x) OSSwapHostToLittleConstInt64(x)
...
#endif /* defined _TLVM_LVM2_ENDIANS_H */
